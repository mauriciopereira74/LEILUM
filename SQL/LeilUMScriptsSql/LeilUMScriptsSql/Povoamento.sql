...
VALUES
    ...
    ('ricardo.costa@email.pt','You Created the Auction with Title:Nikon DSLR 4K(Auction #1,2023-),','2023-11-24 15:35:00'),
    ('maria.silva@email.pt','You Created the Auction with Title:Historic Colonial Mansion(Auction #2,2023-),','2023-11-25 10:45:00'),
    ('ana.carvalho@email.pt','Your Auction Titled: Dress of Collection Saint Laurent(Auction #0,2023-), was APPROVED.','2023-11-25 14:30:00'),
    ('maria.silva@email.pt','Your Auction Titled: Nikon DSLR 4K(Auction #1,2023-), was APPROVED.','2023-11-25 16:00:00'),
    ('lucas@gmail.pt','You Created the Auction with Title:Art is Eternal(Auction #3,2023-),','2023-11-27 21:32:11'),
    ('joao.pereira@email.pt','You Created the Auction with Title:IPhone 15 Pro Max(Auction #4,2023-),','2023-11-27 22:55:12'),
    ('miguel.santos@email.pt','You Created the Auction with Title:Apartment to Sell(Auction #5,2023-),','2023-11-28 11:56:21'),
    ('lucas@gmail.pt','Your Auction Titled: Art is Eternal(Auction #3,2023-), was APPROVED.','2023-11-29 11:30:00'),
    ('joao.pereira@email.pt','Your Auction Titled: IPhone 15 Pro Max(Auction #4,2023-), was APPROVED.','2023-11-29 14:20:00'),
    ('miguel.santos@email.pt','Your Auction Titled: Apartment to Sell(Auction #5,2023-), was APPROVED.','2023-11-29 17:30:00'),
    ('lucas@gmail.pt','You Bid the Auction #5','2023-12-02 12:30:00'),
    ('joao.pereira@email.pt','You Created the Auction with Title:Eletric Guitar(Auction #6,2023-),','2023-12-06 14:30:00'),
    ('ines.ribeiro@email.pt','You Created the Auction with Title:Jewerly Collection(Auction #7,2023-),','2023-12-07 16:35:43'),
    ('miguel.santos@email.pt','You Created the Auction with Title:Cool Jacket(Auction #8,2023-),','2023-12-07 20:40:45'),
    ('lucas@gmail.pt','You Created the Auction with Title:Bluetooth Columns(Auction #9,2023-),','2023-12-07 23:55:00'),
    ('ines.ribeiro@email.pt','Your Auction Titled: Jewerly Collection(Auction #7,2023-), was APPROVED.','2023-12-08 11:45:00'),
    ('miguel.santos@email.pt','Your Auction Titled: Cool Jacket(Auction #8,2023-), was APPROVED.','2023-12-08 15:30:50'),
    ('lucas@gmail.pt','Your Auction Titled: Bluetooth Columns(Auction #9,2023-), was APPROVED.','2023-12-08 18:20:25'),
    ('miguel.santos@email.pt','You Bid the Auction #7','2023-12-10 09:45:30'),
    ('maria.silva@email.pt','You Created the Auction with Title:Pearl Necklace(Auction #10,2023-),','2023-12-10 13:20:20'),
    ('maria.silva@email.pt','Your Auction Titled: Pearl Necklace(Auction #10,2023-), was APPROVED.','2023-12-10 17:00:00'),
    ('ines.ribeiro@email.pt','You Created the Auction with Title:Art of Vincent van Gogh(Auction #11,2023-),','2023-12-13 18:59:00'),
    ('lucas@gmail.pt','You Created the Auction with Title:Modern Warehouse(Auction #12,2023-),','2023-12-13 21:30:05'),
    ('ana.carvalho@email.pt','You Created the Auction with Title:Bluetooth Phones(Auction #13,2023-),','2023-12-13 22:45:45'),
    ('ines.ribeiro@email.pt','Your Auction Titled: Art of Vincent van Gogh(Auction #11,2023-), was APPROVED.','2023-12-14 12:00:00'),
    ('ana.carvalho@email.pt','Your Auction Titled: Bluetooth Phones(Auction #13,2023-), was APPROVED.','2023-12-14 16:45:00'),
